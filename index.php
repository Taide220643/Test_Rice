        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><a href="update.php?km_id=<?php echo $row['km_id']; ?>" class="btn btn-primary">Edit</a></td>
                    <td><a href="delete.php?del=<?php echo $row['km_id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
